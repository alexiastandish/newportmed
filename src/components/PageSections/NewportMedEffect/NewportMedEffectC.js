...
import NewportMedEffectService from "./NewportMedEffectService";
// import "./ServiceSection.scss";
import anime from "animejs";

class NewportMedEffectC extends Component {
  componentDidMount() {
    anime({
        ...
        <div className="section section__centered">
          ...
          <section className="section__centered--services">
            {services.map(service => (
              <div
                key={service.header}
                className="homepage-services__square animeComponent"
              >
                <NewportMedEffectService
                  service={service}
                  descLimit={descLimit}
                />
              </div>
...
export default NewportMedEffectC;
